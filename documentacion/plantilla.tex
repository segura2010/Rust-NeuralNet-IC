...
Estos son algunos de los mejores resultados que he obtenido con mi implementación sencilla de red neuronal. El mejor es el que se consigue con el mayor número de neuronas ocultas y usando los datos con ruido generados. Estos resultados se han conseguido después de muchos experimentos modificando los parámetros, principalmente la tasa de error, para ajustarla de forma que el error se redujese lo máximo posible.
\\\\
Como podemos ver en estos resultados, la tasa de aprendizaje es relativamente alta, y podemos ver el efecto de \textit{Early Stopping}. Como vemos, la tasa de error sobre los datos de entrenamiento es mayor que la tasa de error sobre los datos de test. Esto es uno de los efectos del Early Stopping, no sobreaprendemos los datos de entrenamiento y obtenemos una red neuronal más general, lo que permite que frente a los datos de test funcionen mejor las generalizaciones que ha realizado.
\\\\
...
\\\\
Para concluir, decir que el código, esta documentación y algunos resultados que se han obtenido (entre ellos los resultados expuestos en esta documentación) estarán disponibles en Github por si son de utilidad para alguien. La dirección es \url{https://github.com/segura2010/Rust-NeuralNet-IC} y estará disponible pocos días después de la entrega de la práctica.

\iffalse
Para el formulario:

1 capa oculta y 600 neuronas ocultas, además de las 28x28 neuronas de la capa de entrada y las 10 de la capa de salida.

Backpropagation por Refuerzo online con ruido (60000 imágenes originales + 60000 imágenes con ruido)
Epocas: 3
